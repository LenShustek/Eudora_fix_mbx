...
Any single-character item in the searchstring can optionally be preceded by
     ...
     * to mean "zero or more occurences of this character"
...
or the replacementstring can be one of these:
    ...
    <nochange>           make no change to the searched string (useful for only setting match flags)
    <fixattachment>      special code to fix and rename attachments whose file names were truncated
